...
public class SuperFamiliaPesquisaView extends JDialog {

	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	public SuperFamiliaBean SuperFamilia = new SuperFamiliaBean();
	...
	public static void main(String args[]) {
		java.awt.EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
				SuperFamiliaPesquisaView dialog = new SuperFamiliaPesquisaView(
	...
	public SuperFamiliaPesquisaView(java.awt.Frame parent, boolean modal) {
		super(parent, modal);

		setTitle("Pesquisa SuperFamilia");
				...
				case 0: {
					try {
						...
						DefaultTableModel dtm = (DefaultTableModel) jTBPesquisa
								.getModel();
						dtm.setRowCount(0);
						for (SuperFamiliaBean filo : lista) {
							dtm.addRow(new Object[] { filo.getId(),
									filo.getNome(),
									filo.getSubOrdem().getNome() });
						}
					} catch (Exception e) {
					...
					if (jTPesquisa.getText().equals("")) {
						...
						try {
							...
							InterfaceSuperFamiliaController ifc = ControllerFactory
									.getInstance()
									.getInterfaceSuperFamiliaController();
							SuperFamiliaBean elemento = ifc.pesquisar(id);
							DefaultTableModel dtm = (DefaultTableModel) jTBPesquisa
									.getModel();
							dtm.setRowCount(0);
					...
					if (jTPesquisa.getText().equals("")) {
						...
						try {
							...
							DefaultTableModel dtm = (DefaultTableModel) jTBPesquisa
									.getModel();
							dtm.setRowCount(0);
							List<SuperFamiliaBean> lista = ifc.pesquisar(nome,
									true);
							dtm.setRowCount(0);
							for (SuperFamiliaBean filo : lista) {
								dtm.addRow(new Object[] { filo.getId(),
		...
		jBtCancelar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				SuperFamilia.setId(0l);
				SuperFamilia.setNome("");
				dispose();
			}
		});
			...
			public void keyPressed(KeyEvent e) {
				if (e.getKeyCode() == KeyEvent.VK_ENTER
					...
					if (-1 != index) {
						...
						SuperFamiliaBean filos = ifc.pesquisar(ids);
						SuperFamilia.setId(filos.getId());
						SuperFamilia.setNome(filos.getNome());
						SuperFamilia.setSubOrdem(filos.getSubOrdem());
