...
public class ClassePesquisaView extends JDialog {

	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	public ClasseBean Classe = new ClasseBean();
	...
	public static void main(String args[]) {
		java.awt.EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
				ClassePesquisaView dialog = new ClassePesquisaView(
	...
	public ClassePesquisaView(java.awt.Frame parent, boolean modal) {
		super(parent, modal);

		setTitle("Pesquisa Classe");
				...
				case 1: {
					if (jTPesquisa.getText().equals("")) {
						...
						try {
							...
							ClasseBean Class = ifc.pesquisar(Long
									.parseLong(jTPesquisa.getText()));
							DefaultTableModel dtm = (DefaultTableModel) jTBPesquisa
									.getModel();
							dtm.setRowCount(0);
							dtm.addRow(new Object[] { Class.getId(),
									Class.getNome(),
									Class.getSubFilo().getNome() });
					...
					if (jTPesquisa.getText().equals("")) {
						...
						try {
							...
							InterfaceClasseController ifc = ControllerFactory
									.getInstance()
									.getInterfaceClasseController();
							List<ClasseBean> lista = ifc.pesquisar(nome, true);
							DefaultTableModel dtm = (DefaultTableModel) jTBPesquisa
									.getModel();
							dtm.setRowCount(0);
							for (ClasseBean Classe : lista) {
			...
			public void keyPressed(KeyEvent e) {
				if (e.getKeyCode() == KeyEvent.VK_ENTER
					...
					if (-1 != index) {
						...
						ClasseBean filos = ifc.pesquisar(ids);
						Classe.setId(filos.getId());
						Classe.setNome(filos.getNome());
						Classe.setSubFilo(filos.getSubFilo());
