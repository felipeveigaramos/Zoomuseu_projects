...
public class SubFamiliaPesquisaView extends JDialog {

	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	public SubFamiliaBean SubFamilia = new SubFamiliaBean();
	...
	public static void main(String args[]) {
		java.awt.EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
				SubFamiliaPesquisaView dialog = new SubFamiliaPesquisaView(
	...
	public SubFamiliaPesquisaView(java.awt.Frame parent, boolean modal) {
		super(parent, modal);

		setTitle("Pesquisa SubFamilia");
				...
				case 0: {
					try {
						...
						DefaultTableModel dtm = (DefaultTableModel) jTBPesquisa
								.getModel();
						dtm.setRowCount(0);
						for (SubFamiliaBean filo : lista) {
							dtm.addRow(new Object[] { filo.getId(),
									filo.getNome(), filo.getFamilia().getNome() });
						}
					} catch (Exception e) {
					...
					if (jTPesquisa.getText().equals("")) {
						...
						try {
							...
							InterfaceSubFamiliaController ifc = ControllerFactory
									.getInstance()
									.getInterfaceSubFamiliaController();
							SubFamiliaBean elemento = ifc.pesquisar(id);
							DefaultTableModel dtm = (DefaultTableModel) jTBPesquisa
									.getModel();
							dtm.setRowCount(0);
					...
					if (jTPesquisa.getText().equals("")) {
						...
						try {
							...
							DefaultTableModel dtm = (DefaultTableModel) jTBPesquisa
									.getModel();
							dtm.setRowCount(0);
							List<SubFamiliaBean> lista = ifc.pesquisar(nome,
									true);
							dtm.setRowCount(0);
							for (SubFamiliaBean filo : lista) {
								dtm.addRow(new Object[] { filo.getId(),
			...
			public void keyPressed(KeyEvent e) {
				if (e.getKeyCode() == KeyEvent.VK_ENTER
					...
					if (-1 != index) {
						...
						SubFamiliaBean filos = ifc.pesquisar(ids);
						SubFamilia.setId(filos.getId());
						SubFamilia.setNome(filos.getNome());
						SubFamilia.setFamilia(filos.getFamilia());
