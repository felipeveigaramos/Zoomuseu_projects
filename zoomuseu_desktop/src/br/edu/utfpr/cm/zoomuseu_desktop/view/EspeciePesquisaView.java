...
public class EspeciePesquisaView extends JDialog {

	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	public EspecieBean Especie = new EspecieBean();
	...
	public static void main(String args[]) {
		java.awt.EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
				EspeciePesquisaView dialog = new EspeciePesquisaView(
	...
	public EspeciePesquisaView(java.awt.Frame parent, boolean modal) {
		super(parent, modal);

		setTitle("Pesquisa Especie");
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				case 0: {
					try {
						...
						List<EspecieBean> lista = ifc.pesquisar();
						DefaultTableModel dtm = (DefaultTableModel) jTBPesquisa
								.getModel();
						dtm.setRowCount(0);
						for (EspecieBean filo : lista) {
							dtm.addRow(new Object[] { filo.getId(),
									filo.getNome(),
									filo.getSubGenero().getNome() });
						}
					} catch (Exception e) {
				...
				case 1: {
					if (jTPesquisa.getText().equals("")) {
						...
						try {
							...
							EspecieBean elemento = ifc.pesquisar(id);
							DefaultTableModel dtm = (DefaultTableModel) jTBPesquisa
									.getModel();
							dtm.setRowCount(0);
					...
					if (jTPesquisa.getText().equals("")) {
						...
						try {
							...
							DefaultTableModel dtm = (DefaultTableModel) jTBPesquisa
									.getModel();
							dtm.setRowCount(0);
							List<EspecieBean> lista = ifc.pesquisar(nome, true);
							dtm.setRowCount(0);
							for (EspecieBean filo : lista) {
								dtm.addRow(new Object[] { filo.getId(),
										filo.getNome() });
			...
			public void keyPressed(KeyEvent e) {
				if (e.getKeyCode() == KeyEvent.VK_ENTER
					...
					if (-1 != index) {
						...
						EspecieBean filos = ifc.pesquisar(ids);
						Especie.setId(filos.getId());
						Especie.setNome(filos.getNome());
						Especie.setSubGenero(filos.getSubGenero());
