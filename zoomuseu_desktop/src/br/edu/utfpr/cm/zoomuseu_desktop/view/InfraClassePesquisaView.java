...
public class InfraClassePesquisaView extends JDialog {

	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	public InfraClasseBean InfraClasse = new InfraClasseBean();
	...
	public static void main(String args[]) {
		java.awt.EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
				InfraClassePesquisaView dialog = new InfraClassePesquisaView(
	...
	public InfraClassePesquisaView(java.awt.Frame parent, boolean modal) {
		super(parent, modal);

		setTitle("Pesquisa InfraClasse");
				...
				case 0: {
					try {
						...
						DefaultTableModel dtm = (DefaultTableModel) jTBPesquisa
								.getModel();
						dtm.setRowCount(0);
						for (InfraClasseBean filo : lista) {
							dtm.addRow(new Object[] { filo.getId(),
									filo.getNome(), filo.getSubClasse().getNome() });
						}
					} catch (Exception e) {
					...
					if (jTPesquisa.getText().equals("")) {
						...
						try {
							...
							InterfaceInfraClasseController ifc = ControllerFactory
									.getInstance()
									.getInterfaceInfraClasseController();
							InfraClasseBean elemento = ifc.pesquisar(id);
							DefaultTableModel dtm = (DefaultTableModel) jTBPesquisa
									.getModel();
							dtm.setRowCount(0);
					...
					if (jTPesquisa.getText().equals("")) {
						...
						try {
							...
							DefaultTableModel dtm = (DefaultTableModel) jTBPesquisa
									.getModel();
							dtm.setRowCount(0);
							List<InfraClasseBean> lista = ifc.pesquisar(nome,
									true);
							dtm.setRowCount(0);
							for (InfraClasseBean filo : lista) {
								dtm.addRow(new Object[] { filo.getId(),
			...
			public void keyPressed(KeyEvent e) {
				if (e.getKeyCode() == KeyEvent.VK_ENTER
					...
					if (-1 != index) {
						...
						InfraClasseBean filos = ifc.pesquisar(ids);
						InfraClasse.setId(filos.getId());
						InfraClasse.setNome(filos.getNome());
						InfraClasse.setSubClasse(filos.getSubClasse());
